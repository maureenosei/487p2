    ...
    (e.methods = {
      ...
      setup: function () {
        ...
        e.options.counter && (b += '<div id="quiz-counter"></div>'),
          ...
          (b += '<a href="#" id="quiz-next-btn">' + m + "</a>"),
          (b += '<a href="#" id="quiz-finish-btn">' + n + "</a>"),
          (b += '<a href="#" id="quiz-restart-btn">' + o + "</a>"),
          (b += "</div>"),
          (b += "</div>"),
        ...
        if (!r) {
          ...
          a("#quiz-response").html(d),
            ...
            "function" == typeof e.options.answerCallback &&
              e.options.answerCallback(p, g, f[h]);
        }
      },
      ...
      gameOver: function (b) {
        if (0 === a(l).length) {
          ...
          (c += '<div id="' + l.substr(1) + '">'),
            ...
            (c += '<p><a href="#" id="quiz-retry-btn">' + o + "</a></p>"),
            (c += "</div>"),
            e.$el.append(c);
        }
      ...
      finish: function () {
        e.$el
          ...
          a(k).show();
        var b = e.options.resultsFormat
          .replace("%score", q)
          .replace("%total", g);
        a("#quiz-results").html(b),
